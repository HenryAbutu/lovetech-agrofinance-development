...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Business growth, agrofinance, training and digital solutions for Nigerian MSMEs." },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "LoveTech Agrofinance & Development" },
      { name: "twitter:title", content: "LoveTech Agrofinance & Development" },
      { property: "og:description", content: "Business growth, agrofinance, training and digital solutions for Nigerian MSMEs." },
      { name: "twitter:description", content: "Business growth, agrofinance, training and digital solutions for Nigerian MSMEs." },
