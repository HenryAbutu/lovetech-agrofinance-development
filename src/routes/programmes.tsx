...
const current = [
  { t: "Professionals AI Edge", status: "Enrolment Open", b: "Practical AI tools for more efficient, productive and profitable businesses. ₦10,000 → ₦5,000 launch price.", to: "/academy/courses/professionals-ai-edge", hash: "enrol" },
];
const upcoming = [
